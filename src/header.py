...
train_learning_rate_scheduler_threshold_mode = "rel"
train_learning_rate_scheduler_cooldown = 0
train_learning_rate_scheduler_min_learning_rate = 0
...
train_network_revision = type.NetworkRevision.revision_0
train_optimizer_learning_rate = 1e-3
train_optimizer_momentum = 0.9
train_optimizer_weight_decay = 1e-6
...
test_network_revision = type.NetworkRevision.revision_0
