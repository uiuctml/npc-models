...
dir_dataset_test_adversarial = "../../../datasets/mnist-dataset/images/split/adversarial/test"
...
file_path_dataset_config = "../../visat-dataset-tools/configs/mnist.json"
interpret_delimiter_label = "--"
interpret_dir_dataset = "../../../datasets/mnist-dataset/images/split/original/test"
