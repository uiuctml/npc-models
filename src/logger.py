...
def log_info(*args, **kwargs):
    if config.log_level >= type.LogLevel.info:
        print("[INFO]: ", end = "")
        print(*args, **kwargs)
...
def log_warn(*args, **kwargs):
    if config.log_level >= type.LogLevel.warn:
        print("[WARN]: ", end = "")
        print(*args, **kwargs)
...
def log_error(*args, **kwargs):
    if config.log_level >= type.LogLevel.error:
        print("[ERROR]: ", end = "")
        print(*args, **kwargs)
...
def log_fatal(*args, **kwargs):
    if config.log_level >= type.LogLevel.fatal:
        print("[FATAL]: ", end = "")
        print(*args, **kwargs)
